...
$.getScript('http://relle.ufsc.br/exp_data/6/1/welcome.js', function () {
...
$.getScript('http://relle.ufsc.br/exp_data/6/1/zoom.js', function () {
...
function report(id) {
    ...
    $.ajax({
        ...
        success: function (pdf) {
            ...
            //window.focus();
            var win = window.open("https://relle.ufsc.br/labs/" + id + "/report", '_blank');
            win.focus();
